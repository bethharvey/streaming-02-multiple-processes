...
def prepare_message_from_row(row):
    ...
    fstring_message = f"[{ID}, {Name}, {Sex}, {Age}, {Height}, {Weight}, {Team}, {NOC}, {Games}, {Year}, {Season}, {City}, {Sport}, {Event}, {Medal}]"
...
def stream_row(input_file_name, address_tuple, output_file_name):
    ...
    with open(input_file_name, "r") as input_file:
        ...
        with open(output_file_name, "w", newline="") as output_file:
            ...
            writer.writerow(['ID', 'Name', 'Sex', 'Height', 'Weight', 'Team', 'NOC', 'Games', 'Year', 'Season', 'City', 'Sport', 'Event', 'Medal'])
